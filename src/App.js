...
function App() {
  ...
  return (
    ...
    <div className="App">
      ...
      <p> Finally, I edited App.js file to put in the content for this page.  </p>
    ...
    <div className = "App">
      ...
      <p> P.S This assignment also helped me fix my other configuration related issues on my computer. </p>
    </div>
    <p>Counter: {count} </p>
